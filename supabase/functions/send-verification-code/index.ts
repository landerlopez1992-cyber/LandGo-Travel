...
serve(async (req) => {
  ...
  try {
    ...
    console.log('🔍 DEBUG: Processing email type:', type)
    console.log('🔍 DEBUG: Email data:', { email, type, fullName, code })
    ...
    switch (type) {
      ...
      case 'profile_update':
        ...
        console.log('🔍 DEBUG: Email subject set to:', emailSubject)
        emailHtml = generateBaseHTML(`
          <div style="text-align: center;">
            <div class="success-icon">🔐</div>
            <h2 style="color: #1F2937; margin: 0 0 20px 0;">Profile Update Verification</h2>
          </div>
