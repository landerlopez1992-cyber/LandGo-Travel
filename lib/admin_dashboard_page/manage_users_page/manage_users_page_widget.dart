...
/// Create a page named "AdminUserManagementPage" for the LandGo Travel admin
/// panel.
///
/// Elements to include:
///
/// 1. Title at the top: "User Management"
///
/// 2. A search bar to find users by name, email, or ID
///
/// 3. A list or table of users displaying:
///    - Profile photo
///    - Full name
///    - Email
///    - Membership level
...
///    - Date registered
///    - Action buttons: [View, Block, Unblock, Edit]
///
/// 4. Include a section for:
///    - Total users
///    - Number of active vs blocked users
///
/// 5. Use tabs or filters: All Users | Active | Blocked
///
/// Design colors:
/// Primary: #023047
/// Accent: #FFB703
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.network(
                                      'https://images.unsplash.com/photo-1494790108755-2616b612b1e5?w=200&h=200',
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
