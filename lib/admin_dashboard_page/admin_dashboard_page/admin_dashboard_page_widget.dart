...
/// Create a new page named "AdminDashboardPage" for the LandGo Travel app.
///
/// At the top, add a centered title: "Admin Dashboard".
///
/// Below the title, create a blank container that will hold multiple admin
/// sections.
///
/// Use a clean, professional design with a white background and padding.
///
/// Apply LandGo Travel’s admin color scheme:
/// Primary: #023047
/// Secondary: #0077B6
/// Accent: #FFB703
/// Background: #F1FAFB
/// Text: #1E1E1E
///
/// Make it mobile-responsive and ready to add grid cards later.
