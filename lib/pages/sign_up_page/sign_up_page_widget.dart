...
/// Create a Sign Up page for the LandGo Travel app using a consistent brand
/// color scheme.
///
/// The layout should be clean and user-friendly. At the top, display the app
/// logo, followed by a title that says "Create your account". Include buttons
/// for "Sign up with Google" and "Sign up with Phone Number". Below, add
/// input fields for Full Name, Email, and Password. Add a checkbox for
/// accepting terms and privacy policy. Then include a large "Sign Up" button.
/// At the bottom, add text saying "Already have an account?" with a link to
/// Log In. Use the brand color palette: primary #0077B6, secondary #00B4D8,
/// background #F1FAFB, text #023047, accent #FFB703.
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Opacity(
                        opacity: 0.7,
                        child: Text(
                          'Join LandGo and start your travel journey',
                          textAlign: TextAlign.center,
                          style:
