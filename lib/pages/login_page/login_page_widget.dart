...
/// Design a login page for the LandGo Travel app that supports multiple login
/// methods.
///
/// The top should display the app’s logo, followed by a title that says "Log
/// in to your account". Below the title, add buttons for "Continue with
/// Google" and "Continue with Phone Number". Below those, add two input
/// fields for "Email" and "Password", and a "Log In" button. Include a
/// "Forgot Password?" link below the password field. At the bottom, display
/// "Don't have an account?" with a link to the Sign Up page. Also include a
/// secondary link that says "Continue as guest". Use a clean layout with
/// travel-themed background or accent colors.
