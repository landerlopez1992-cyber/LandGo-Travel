  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case UserDirectLineageRow:
            return UserDirectLineageRow(data);
          case FlightBookingsRow:
            return FlightBookingsRow(data);
          case PaymentsRow:
            return PaymentsRow(data);
          case ReferralsRow:
            return ReferralsRow(data);
          case DailyActivityRow:
            return DailyActivityRow(data);
          case PointTransactionsRow:
            return PointTransactionsRow(data);
          case UserActivitiesRow:
            return UserActivitiesRow(data);
          case TopReferrersRow:
            return TopReferrersRow(data);
          case MembershipStatsRow:
            return MembershipStatsRow(data);
          case ProfilesRow:
            return ProfilesRow(data);
          case MembershipsRow:
            return MembershipsRow(data);
          case UserDashboardRow:
            return UserDashboardRow(data);
          case CashbackTransactionsRow:
            return CashbackTransactionsRow(data);
          case HotelBookingsRow:
            return HotelBookingsRow(data);
          case TravelPointsRow:
            return TravelPointsRow(data);
          case ReferralTreeRow:
            return ReferralTreeRow(data);
          case RecentTransactionsRow:
            return RecentTransactionsRow(data);
          case NotificationsRow:
            return NotificationsRow(data);
          case SystemConfigRow:
            return SystemConfigRow(data);
          default:
            return null;
        }
