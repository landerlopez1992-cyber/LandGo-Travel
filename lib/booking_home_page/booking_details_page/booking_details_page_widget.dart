...
/// Create a Booking Details Page for the LandGo Travel app.
///
/// At the top, display the flight route (e.g., "Miami to Cancun") and date.
///
/// Include a detailed card that shows:
...
/// - Price per passenger
///
/// Below the flight details, add a section for user information:
/// - Full Name (text input)
/// - Date of Birth (date picker)
/// - Passport Number (text input)
///
/// Below that, include a large primary button labeled "Continue to Checkout".
///
/// Use travel-related icons and apply the LandGo Travel brand colors:
/// Primary: #0077B6
/// Secondary: #00B4D8
/// Background: #F1FAFB
/// Text: #023047
/// Accent: #FFB703
///
/// Design should be mobile-optimized and intuitive.
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Please ensure your passport is valid for at least 6 months from travel date and matches the name on your booking exactly.',
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          font: GoogleFonts.inter(
