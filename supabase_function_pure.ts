...
serve(async (req) => {
  ...
  try {
    ...
    console.log('🔍 DEBUG: Processing request:', { email, type, fullName, userId, code });
    ...
    const generateBaseHTML = (content: string) => `
      ...
      <head>
        ...
        <style>
          ...
          .header { 
            background: linear-gradient(135deg, #37474F 0%, #2C2C2C 100%); 
            color: white; 
            padding: 30px; 
            text-align: center; 
          }
        ...
        <div class="container">
          ...
          <div class="footer">
            <div class="company-info">
              <p style="margin: 0 0 10px 0; font-weight: bold; color: #FFFFFF;">LandGo Travel</p>
              <p style="margin: 5px 0; color: #888888;">14703 Southern Blvd, Loxahatchee, FL 33470</p>
              <p style="margin: 5px 0; color: #888888;">West Palm Beach, Florida</p>
              <p style="margin: 5px 0; color: #888888;">📧 info@landgotravel.com</p>
              <p style="margin: 5px 0; color: #888888;">📞 +1 561 600 0229</p>
            </div>
    ...
    const generateProductCard = (product: any) => `
      <div class="product-card">
        ...
        <div class="product-info">
          ...
          ${product.description ? `<div style="font-size: 12px; color: #888888; margin-top: 8px;">${product.description}</div>` : ''}
        </div>
      </div>
    `;
    ...
    switch (type) {
      case 'email_confirmation':
        ...
        emailHtml = generateBaseHTML(`
          <div style="text-align: center;">
            ...
            <h2 style="color: #FFFFFF; margin: 0 0 20px 0;">Welcome to LandGo Travel!</h2>
          </div>
          ...
          <div class="booking-details">
            <h3 style="color: #FFFFFF; margin: 0 0 15px 0;">What happens next?</h3>
      ...
      case 'welcome':
        ...
        emailHtml = generateBaseHTML(`
          <div style="text-align: center;">
            <div class="success-icon">🎉</div>
            <h2 style="color: #FFFFFF; margin: 0 0 20px 0;">Welcome to the LandGo Travel Family!</h2>
          </div>
          <p>Hello <strong>${fullName || 'Traveler'}</strong>,</p>
          ...
          <div class="booking-details">
            <h3 style="color: #FFFFFF; margin: 0 0 15px 0;">What LandGo Travel offers you:</h3>
            <div class="detail-row">
      ...
      case 'verification':
        ...
        emailHtml = generateBaseHTML(`
          <div style="text-align: center;">
            <div class="success-icon">🔐</div>
            <h2 style="color: #FFFFFF; margin: 0 0 20px 0;">Verification Code</h2>
          </div>
      ...
      case 'profile_update':
        ...
        try {
          ...
          console.log('  - Email:', email);
          console.log('  - Type: profile_update');
          ...
          console.log('🔍 SUCCESS: Verification code saved to DB:', data);
        } catch (dbError) {
      ...
      case 'password_changed':
        ...
        emailHtml = generateBaseHTML(`
          <div style="text-align: center;">
            <div class="success-icon">🔒</div>
            <h2 style="color: #FFFFFF; margin: 0 0 20px 0;">Password Updated Successfully</h2>
          </div>
          <p>Hello <strong>${fullName || 'User'}</strong>,</p>
          <p>Your password has been successfully updated for your LandGo Travel account. Your account security is now enhanced.</p>
          <div class="booking-details">
            <h3 style="color: #FFFFFF; margin: 0 0 15px 0;">Security Information:</h3>
            <div class="detail-row">
          ...
          <div class="security-notice">
            <p style="margin: 0;"><strong>Security Alert:</strong> If you did not make this change, please contact our support team immediately at info@landgotravel.com or call +1 561 600 0229.</p>
          </div>
          <p>Thank you for keeping your account secure!</p>
          <p style="margin: 20px 0 0 0;"><strong>The LandGo Travel Team</strong></p>
        `);
      ...
      case 'flight_booking':
        ...
        emailHtml = generateBaseHTML(`
          <div style="text-align: center;">
            <div class="success-icon">✈️</div>
            <h2 style="color: #FFFFFF; margin: 0 0 20px 0;">Flight Booking Confirmed!</h2>
          </div>
          <p>Hello <strong>${fullName || 'Traveler'}</strong>,</p>
          <p>Your flight has been successfully booked. Here are your booking details:</p>
          <div class="booking-details">
            <h3 style="color: #FFFFFF; margin: 0 0 15px 0;">Flight Details:</h3>
            <div class="detail-row">
          ...
          <div class="booking-details">
            <h3 style="color: #FFFFFF; margin: 0 0 15px 0;">Passenger Information:</h3>
            <div class="detail-row">
      ...
      case 'hotel_booking':
        ...
        emailHtml = generateBaseHTML(`
          <div style="text-align: center;">
            <div class="success-icon">🏨</div>
            <h2 style="color: #FFFFFF; margin: 0 0 20px 0;">Hotel Booking Confirmed!</h2>
          </div>
          <p>Hello <strong>${fullName || 'Traveler'}</strong>,</p>
          <p>Your hotel reservation has been successfully confirmed. Here are your booking details:</p>
          <div class="booking-details">
            <h3 style="color: #FFFFFF; margin: 0 0 15px 0;">Hotel Details:</h3>
            <div class="detail-row">
          ...
          <div class="booking-details">
            <h3 style="color: #FFFFFF; margin: 0 0 15px 0;">Guest Information:</h3>
            <div class="detail-row">
              <span class="detail-label">Name:</span>
              <span class="detail-value">${passengerData?.fullName || fullName || 'N/A'}</span>
            </div>
        ...
        if (marketingData?.products && Array.isArray(marketingData.products)) {
          productsHTML = `
            <div class="product-grid">
              ${marketingData.products.map((product: any) => generateProductCard(product)).join('')}
            </div>
          `;
        }
        emailHtml = generateBaseHTML(`
          ...
          <div class="booking-details">
            <h3 style="color: #FFFFFF; margin: 0 0 15px 0;">Offer Details:</h3>
            ${marketingData.offerDetails}
          </div>
          ` : ''}
          <div style="text-align: center;">
      ...
      default:
        ...
        emailHtml = generateBaseHTML(`
          <div style="text-align: center;">
            <div class="success-icon">📧</div>
            <h2 style="color: #FFFFFF; margin: 0 0 20px 0;">Notification</h2>
          </div>
          <p>Hello <strong>${fullName || 'User'}</strong>,</p>
    ...
    const resendResponse = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'LandGo Travel <info@landgotravel.com>',
        to: [email],
